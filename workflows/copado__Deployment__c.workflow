...
<Workflow xmlns="http://soap.sforce.com/2006/04/metadata">
    <alerts>
        <fullName>Deployment_Status_Notification</fullName>
        <ccEmails>swetha.mittakolu@accenture.com</ccEmails>
        <description>Deployment Status Notification</description>
